...
func (l *NullLogger) Trace(reqContext interface{}, loggingCtx string, msg string, args ...interface{}) {
}

// Debug logs a debug entry.
func (l *NullLogger) Debug(reqContext interface{}, loggingCtx string, msg string, args ...interface{}) {
}

// Info logs an info entry.
func (l *NullLogger) Info(reqContext interface{}, loggingCtx string, msg string, args ...interface{}) {
}

// Warn logs a warn entry.
func (l *NullLogger) Warn(reqContext interface{}, loggingCtx string, msg string, args ...interface{}) error {
	return nil
}

// Error logs an error entry.
func (l *NullLogger) Error(reqContext interface{}, loggingCtx string, msg string, args ...interface{}) error {
	return nil
}

// Fatal logs a fatal entry then panics.
func (l *NullLogger) Fatal(reqContext interface{}, loggingCtx string, msg string, args ...interface{}) {
	panic("exit due to fatal error")
}

// Log logs a leveled entry.
func (l *NullLogger) Log(reqContext interface{}, loggingCtx string, level int, msg string, args []interface{}) {
}
