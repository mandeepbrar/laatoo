...
type Formatter interface {
	Format(reqContext interface{}, loggingCtx string, writeHandler WriteHandler, level int, msg string, args []interface{})
}
...
func (tf *TextFormatter) Format(reqContext interface{}, loggingCtx string, writeHandler WriteHandler, level int, msg string, args []interface{}) {
	buf := pool.Get()
	defer pool.Put(buf)
