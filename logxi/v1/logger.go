...
const InternalLogContext = "logxi"
...
type Logger interface {
	...
	Warn(reqContext interface{}, loggingCtx string, msg string, args ...interface{}) error
	Error(reqContext interface{}, loggingCtx string, msg string, args ...interface{}) error
	Fatal(reqContext interface{}, loggingCtx string, msg string, args ...interface{})
	Log(reqContext interface{}, loggingCtx string, level int, msg string, args []interface{})
