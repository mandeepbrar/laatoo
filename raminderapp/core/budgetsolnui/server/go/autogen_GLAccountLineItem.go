...
/*type GLAccountLineItem_Ref struct {
  Id    string
  Title string
}*/

type GLAccountLineItem struct {
	...
	Value	int64 `json:"Value" bson:"Value" datastore:"Value"`
...
func (ent *GLAccountLineItem) Config() *data.StorableConfig {
...
func (ent *GLAccountLineItem) ReadAll(c ctx.Context, cdc core.Codec, rdr core.SerializableReader) error {
	var err error
    ...
    if err = rdr.ReadInt64(c, cdc, "Value", &ent.Value); err != nil {
      return err
    }
...
func (ent *GLAccountLineItem) WriteAll(c ctx.Context, cdc core.Codec, wtr core.SerializableWriter) error {
	var err error
    ...
    if err = wtr.WriteInt64(c, cdc, "Value", &ent.Value); err != nil {
      return err
    }
