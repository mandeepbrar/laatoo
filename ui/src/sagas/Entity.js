...
function* getEntityData(action) {
  try {
    ...
    const resp = yield call(EntityData.GetEntity, action.payload.entityName, action.payload.entityId, action.payload.headers, action.payload.svcUrl);
...
function* deleteEntityData(action) {
  try {
    ...
    const resp = yield call(EntityData.DeleteEntity, action.payload.entityName, action.payload.entityId, action.payload.headers, action.payload.svcUrl);
...
function* saveEntityData(action) {
  try {
    ...
    const resp = yield call(EntityData.SaveEntity, action.payload.entityName, action.payload.data, action.payload.headers, action.payload.svcUrl);
...
function* putEntityData(action) {
  try {
    ...
    const resp = yield call(EntityData.PutEntity, action.payload.entityName, action.payload.entityId, action.payload.data, action.payload.headers, action.payload.svcUrl);
...
function* updateEntityData(action) {
  try {
    ...
    const resp = yield call(EntityData.UpdateEntity, action.payload.entityName, action.payload.entityId, action.payload.data, action.payload.headers, action.payload.svcUrl);
