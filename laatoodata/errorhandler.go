...
const (
	...
	DATA_ERROR_MISSING_OBJECT            = "Data_Error_Missing_Object"
...
func init() {
	...
	errors.RegisterCode(DATA_ERROR_MISSING_COLLECTION, errors.ERROR, fmt.Errorf("Collection name not provided."))
	errors.RegisterCode(DATA_ERROR_MISSING_OBJECT, errors.ERROR, fmt.Errorf("Name of the object stored in the database not provided."))
