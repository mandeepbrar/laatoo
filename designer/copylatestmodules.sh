...
cp $MODULES_DIR/filesystemstorage.tar.gz $MODULES_DIR/staticfileserver.tar.gz $MODULES_DIR/publicdirserver.tar.gz $MODULES_DIR/publicfilesserver.tar.gz \
  $MODULES_DIR/dataadapter.tar.gz $MODULES_DIR/mongodatabase.tar.gz $MODULES_DIR/shell.tar.gz $MODULES_DIR/ui.tar.gz $MODULES_DIR/laatooui.tar.gz dist/config/designer/modules
...
cp $MODULES_DIR/designerui.tar.gz dist/config/designer/modules
