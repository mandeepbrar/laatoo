...
compile_module() {
  docker run --rm -it -v $nodeModulesFolder:/nodemodules -v $pluginsRoot:/plugins -v $deploy:/deploy -e name=$1 -e packageFolder=$2 -e verbose=true  -e forceUIModules=true laatoomodulebuilder
  echo '================================================================'
}
