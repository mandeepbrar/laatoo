...
func (ldr *objectLoaderProxy) Register(ctx core.Context, objectName string, object interface{}, metadata core.Info) {
...
func (ldr *objectLoaderProxy) RegisterObject(ctx core.Context, objectName string, objectCreator core.ObjectCreator, objectCollectionCreator core.ObjectCollectionCreator, metadata core.Info) {
...
func (ldr *objectLoaderProxy) GetMetaData(ctx core.Context, objectName string) (core.Info, error) {
