...
var rootCmd = &cobra.Command{
	Use:   "laatoo [subcommands] [flags] arguments",
	Short: "Command line utility for managing laatoo",
	Long:  `This application is a command line utility to manage and work with laatoo framework`,
}
...
func exitWithError(err error, args ...string) {
	fmt.Println("Error encountered ", err.Error())
}

func getInput(msg string, val *string) {
	fmt.Println("")
	fmt.Print(msg)
	fmt.Scanln(val)
}
