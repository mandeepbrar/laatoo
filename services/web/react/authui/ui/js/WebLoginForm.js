...
function renderWebLogin(settings, properties) {
  return function (state, handleChange, handleLogin, oauthLogin, props) {
    ...
    console.log("renderLogin", properties,"uikit", _uikit,"settigs", settings, "props", props);
    return (
          ...
          <div className="main">
            <_uikit.Form role="form">
              <div className="userfield">
                ...
                <_uikit.TextField className="text" name="email" value={state.email} placeholder={properties.loginForm.userplaceholder} onChange={handleChange} />
              </div>
              <div className="passwordfield">
                <label htmlFor="inputPassword">{properties.loginForm.passwordlabel}</label>
                <_uikit.TextField type="password" className="text" name="password" value={state.password} placeholder={properties.loginForm.passwordplaceholder} onChange={handleChange} />
              </div>
