...
func (fs *NamedFileService) Initialize(ctx core.ServerContext, conf config.Config) error {
...
func (fs *NamedFileService) Invoke(ctx core.RequestContext) error {
...
func (fs *NamedFileService) Start(ctx core.ServerContext) error {
...
func (fs *NamedFileService) runtimeReplace(ctx core.RequestContext, content *[]byte, replacements []*replacement) *[]byte {
	retVal := *content
