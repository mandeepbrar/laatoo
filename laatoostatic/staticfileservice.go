...
func StaticServiceFactory(ctx core.Context, conf map[string]interface{}) (interface{}, error) {
...
func (svc *StaticService) Initialize(ctx core.Context) error {
	return nil
}

//The service starts serving when this method is called
func (svc *StaticService) Serve(ctx core.Context) error {
	return nil
}
...
//Execute method
func (svc *StaticService) Execute(ctx core.Context, name string, params map[string]interface{}) (interface{}, error) {
	return nil, nil
}
