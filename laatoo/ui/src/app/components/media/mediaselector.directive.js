(function() {
    ...
    function mediaselector() {
        ...
        /** @ngInject */
        function MediaSelectCtrl($scope, $element, $attrs, $http, $uibModal) {
			$scope.model = {};
	        $scope.field = "";
	        if ($attrs.mediatype) {
			...
			$scope.imageserver = document.Application.ImageServer;
	    ...
	    /** @ngInject */
	    function modalDialogController($scope, $uibModalInstance, FileUploader, mediatype, allowupload, allowlibrary, allowexternalurl) {
