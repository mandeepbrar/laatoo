(function() {
    ...
    mod.factory('RequestBuilderService', RequestBuilderService);

    /** @ngInject */
    function RequestBuilderService() {
		var requestbuildersvc={}
		
		requestbuildersvc.ParameterSeparatorRequest = function(params, data, urlparams) {
		...
		requestbuildersvc.DefaultRequest = function(params, data) {
			var defaultRequest = {};
			if(data == null) {
				data = {};
			}
		...
		requestbuildersvc.URLParamsRequest = function(urlparams, data) {
