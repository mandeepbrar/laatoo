...
const (
	CORE_APPLICATION_NOT_CREATED       = "Core_Application_Not_Created"
	CORE_APPLICATION_NOT_INITIALIZED   = "Core_Application_Not_Initialized"
...
func init() {
	errors.RegisterCode(CORE_APPLICATION_NOT_CREATED, errors.FATAL, fmt.Errorf("Application could not be created."))
	...
	errors.RegisterCode(CORE_APPLICATION_NOT_INITIALIZED, errors.FATAL, fmt.Errorf("Application could not be initialized."))
