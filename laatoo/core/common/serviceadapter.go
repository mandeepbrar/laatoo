...
func NewService(ctx core.ServerContext, alias string, servFunc core.ServiceFunc) core.Service {
	if servFunc != nil {
...
func (svc *serviceImpl) Initialize(ctx core.ServerContext, conf config.Config) error {
	return nil
}

func (svc *serviceImpl) Invoke(ctx core.RequestContext) error {
	return svc.servFunc(ctx)
}

func (svc *serviceImpl) Start(ctx core.ServerContext) error {
	return nil
}
