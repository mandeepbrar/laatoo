...
const (
	...
	VIEW_ERROR_MISSING_VIEWOBJECTNAME = "View_Error_Incorrect_Viewobjectname"
...
func init() {
	...
	errors.RegisterCode(VIEW_ERROR_MISSING_VIEWOBJECTNAME, errors.FATAL, fmt.Errorf("Object name not provided for view."), LOGGING_CONTEXT)
